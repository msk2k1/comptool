...
try:
    ...
    parser.add_argument('-l', '--left-root', help='Overrides left root definition from config file.')
    parser.add_argument('-r', '--rite-root', '--right-root', help='Overrides right root definition from config file.')
